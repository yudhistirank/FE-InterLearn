...
<div className="flex flex-col md:flex-row justify-center items-start p-8">
                    <div className="md:w-1/2 p-4">
                        <h2 className="text-2xl font-bold text-blue-700 mb-4">Rincian</h2>
                    ...
                    <div className="md:w-1/2 p-4">
                        <h2 className="text-2xl font-bold text-blue-700 mb-4">Keterampilan yang Akan Anda Peroleh</h2>
                        <ul className="space-y-4">
                            <li className="flex items-start">
